    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-[#F3F3F3]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                {/* Submit Button */}
                <div>
                    <button type="submit" className="bg-yellow-800 text-white px-6 py-2 rounded hover:bg-yellow-900 transition flex items-center gap-2" > <IoIosRestaurant></IoIosRestaurant> Add Item</button>
                </div>
            </form>
        </div>
    );
